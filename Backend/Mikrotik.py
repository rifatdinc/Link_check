            ...
            if c  == "false":
                ...
                return {
                    ...
                    'wireless': [{
                        ...
                        'Signal': {
                            "Signal1": self.sinyal1 if len(self.ApR) > 0 else "Data Boş",
                            "Signal2": self.sinyal2 if len(self.ApR) > 0 else "Data Boş",
                            "Signal3": self.sinyal3 if len(self.ApR) > 0  else "Data Boş",
                            "Signal4": self.sinyal4 if len(self.ApR) > 0 else "Data Boş"
